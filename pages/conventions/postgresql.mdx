---
title: 'PostgreSQL'
description: 'Naming conventions for PostgreSQL database objects'
---

<Info>
  **Note**: This document outlines the naming conventions for PostgreSQL database objects, including tables, columns, indexes, and constraints. This file can be used for code generation as a master prompt or just contextual file.
</Info>

<Tip>
    Following this guide: https://www.bytebase.com/blog/postgres-sql-review-guide/
</Tip>
...
- The primary key is allowed to be generated automatically using Serial, and it is recommended to use the Default `next_id()` generator function.
...
- Use triggers for columns like `created_time` and `updated_time` to update the values of these columns automatically.
